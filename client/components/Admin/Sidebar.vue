<template>
  <aside class="bg-white-100 w-1/4 p-4">
    ...
    <nav>
      <ul>
        <li class="mb-4">
          <NuxtLink class="flex items-center" to="/Admin/dashboard">
        ...
        <li class="mb-4">
          <NuxtLink to="/Admin/ManageAppointments" class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512" height="25px" width="25px">
        ...
        <li class="mb-4">
          <NuxtLink to="/Admin/ManagePatients" class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512" height="25px" width="25px">
              <rect fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="32" x="48" y="80" width="416"
                height="384" rx="48" />
              <circle cx="296" cy="232" r="24" />
        ...
        <li class="mb-4">
          <NuxtLink to="/Admin/ManageDoctors" class="flex items-center" >
            <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512" height="25px" width="25px">
              <rect x="32" y="112" width="448" height="352" rx="48" ry="48" fill="none" stroke="currentColor"
