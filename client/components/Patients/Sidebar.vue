<template>
  <aside class="bg-white-100 w-1/4 p-4">
    <div class=" mb-8 text-4xl font-semibold Poppins">
      <NuxtLink to="/Patients/dashboard">
    ...
    <nav>
      <ul>
        <li class="mb-4">
          <NuxtLink class="flex items-center" to="/Patients/dashboard">
        ...
        <li class="mb-4">
          <NuxtLink to="/Patients/Appointments" class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512" height="25px" width="25px">
        ...
        <li class="mb-4">
          <NuxtLink class="flex items-center" to="/Patients/DoctorsPage">
            <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512" height="25px" width="25px">
